...
export default function ({}: Props) {
  return (
    ...
    className='h-screen flex relative flex-col text-center md:text-left md:flew-row
    max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        <div className='space-y-10 px-0 md:px-10'>
            ...
            I'm Ian Sánchez, a young and versatile web developer dedicated to crafting exceptional digital experiences.
